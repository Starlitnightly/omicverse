...
|-----|----------|-------------|
| `X_tgpt` | `adata.obsm` | Cell embeddings (512-dim) |
...
- **Repository / Checkpoint:** [https://github.com/deeplearningplus/tGPT](https://github.com/deeplearningplus/tGPT)
...
For a step-by-step walkthrough with code, see the [tGPT Tutorial Notebook](t_fm_tgpt.ipynb).
