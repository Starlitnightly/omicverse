...
Multi-scale multicellular biology modeling, captures cell-cell communication and tissue-level organization

!!! tip "When to choose PULSAR"

    User wants cell-cell communication analysis, tissue-level modeling, multicellular programs, or intercellular signaling
...
| **Preprocessing** | Standard preprocessing. For tissue-level analysis, include spatial or neighborhood context if available. |
...
|-----|----------|-------------|
| `X_pulsar` | `adata.obsm` | Cell embeddings (512-dim) |
...
- **Repository / Checkpoint:** [https://github.com/pulsar-ai/PULSAR](https://github.com/pulsar-ai/PULSAR)
...
For a step-by-step walkthrough with code, see the [PULSAR Tutorial Notebook](t_fm_pulsar.ipynb).
