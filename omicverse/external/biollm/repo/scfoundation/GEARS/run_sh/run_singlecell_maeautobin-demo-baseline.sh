...
result_dir=${workdir}/results/${data_name}/${train_gene_set_size}/baseline_${split}_seed_${seed}_hidden_${hidden_size}_epochs_${epochs}_batch_${batch_size}_accmu_${accumulation_steps}_mode_${mode}_highres_${highres}_lr_${lr}/${TIMESTAMP}/
