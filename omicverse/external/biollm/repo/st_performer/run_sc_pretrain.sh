...
torchrun --nproc_per_node=4 --master_port=2222 --nnodes=${NNODES} --node_rank=${NODE_RANK} --master_addr=${MASTER_IP} main.py \
	--lmdb_path /home/share/huada/home/qiuping1/workspace/llm/data/panglao/human_process/train.db \
  --test_lmdb_path /home/share/huada/home/qiuping1/workspace/llm/data/panglao/human_process/val.db \
  ...
  --is_exp_emb --do_eval --pretrain --distributed
