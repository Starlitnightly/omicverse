...
def bulk2single_plot_cellprop(generate_single_data:anndata.AnnData,
    ...
    """
    Plot the inferred cell-type composition of bulk-to-single generated cells to inspect deconvolution plausibility
    
    Parameters
    ----------
    generate_single_data : anndata.AnnData
        Input parameter for `bulk2single_plot_cellprop`.
    celltype_key : str
        Input parameter for `bulk2single_plot_cellprop`.
    ...
    Tuple[matplotlib.figure.Figure,matplotlib.axes._axes.Axes]
        Output produced by `bulk2single_plot_cellprop`.
    ...
    Examples
    --------
    >>> ov.bulk2single.bulk2single_plot_cellprop(generate_single_data, celltype_key="Cell_type")
    """
...
def bulk2single_plot_correlation(single_data:anndata.AnnData,
    ...
    """
    Compare reference and generated single-cell profiles by cell-type-level correlation to evaluate bulk2single reconstruction fidelity
    
    Parameters
    ----------
    single_data : anndata.AnnData
        Input parameter for `bulk2single_plot_correlation`.
    generate_single_data : anndata.AnnData
        Input parameter for `bulk2single_plot_correlation`.
    celltype_key : str
        Input parameter for `bulk2single_plot_correlation`.
    ...
    -------
    Tuple[matplotlib.figure.Figure,matplotlib.axes._axes.Axes]
        Output produced by `bulk2single_plot_correlation`.
    ...
    Examples
    --------
    >>> ov.bulk2single.bulk2single_plot_correlation(single_data, generate_single_data, celltype_key="Cell_type")
    """
